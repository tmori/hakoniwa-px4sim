...
#else
    double torque_theta = - (phys.param.l * phys.param.p * ( propeller.w[0] * propeller.w[0] + propeller.w[1] * propeller.w[1]) / 2.0f)
                          + (phys.param.l * phys.param.p * ( propeller.w[2] * propeller.w[2] + propeller.w[3] * propeller.w[3]) / 2.0f);
#endif
